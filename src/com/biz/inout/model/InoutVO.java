...
public class InoutVO {
	...
	public InoutVO(String day, String goods, int price, String inout, int amount, int inTotal, int outTotal) {
		super();
		this.day = day;
		this.goods = goods;
		this.price = price;
	...
	public String toString() {
		return "InoutVO [day=" + day + ", goods=" + goods + ", price=" + price + ", inout=" + inout + ", amount="
